...
class Parser {
    ...
    static func parse(rid: Int?,
                      cid: Int?,
                      event: String?) -> MessageType {
        if (event != nil) {
            if (event == "#publish") {
    ...
    static func getMessageDetails(myMessage: Any) -> (data: Any?, rid: Int?, cid: Int?, eventName: String?, error: Any?)? {
        guard let messageItem = myMessage as? [String: Any] else { return nil }
